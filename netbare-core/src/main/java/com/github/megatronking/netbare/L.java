                    ...
                    if (isNeedWrapper) {
                        if (isNeedCallstackInfo) {
                            ...
                            sb.append("\n").append(content_title_begin).append("\n").append(CONTENT_LINE)
                                    .append(String.format(content_simple_callstack, getCurrentProcessName(getContext(mContext)), ste.getClassName(),
                        ...
                        if (isNeedCallstackInfo) {
                            ...
                            sb.append(String.format(content_simple_callstack, getCurrentProcessName(getContext(mContext)), ste.getClassName(),
                                    ste.getMethodName(), ste.getLineNumber()));
                        }
                    }
                    isKeeping = false;
